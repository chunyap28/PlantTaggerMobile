...
namespace Plant_Tagger.Services
{
    public class RequestProvider : IRequestProvider
    {
        ...
        public async Task<TResult> PostAsync<TResult>(string uri, MultipartFormDataContent data, string token = "", string header = "")
        {
            HttpClient httpClient = CreateHttpClient(token);
        ...
        public async Task<TResult> PutAsync<TResult>(string uri, MultipartFormDataContent data, string token = "", string header = "")
        {
            HttpClient httpClient = CreateHttpClient(token);
